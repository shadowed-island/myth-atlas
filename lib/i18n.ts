...
export const uiText = {
  ...
  explorer: localized("Explorer", "探索区", "Explorador", "المستكشف"),
  listView: localized("List view", "列表视图", "Vista de lista", "عرض القائمة"),
  cardView: localized("Card view", "卡片视图", "Vista de tarjetas", "عرض البطاقات"),
